...
const Dashboard = () => {
  ...
  const getData = async () => {
    try {
      ...
      const { data } = await axios.get(`${HOST_URL}percentage/rubbish`, config);
      // const { data } = await axios.get(`${LOCAL_URL}dashboard`, config);
                    ...
                    <div className="card">
                      <div className="card-body text-center px-3 py-4-5">
                        ...
                        {item.status == "Belum Penuh" ? (
                          <svg width="150px" height="150px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <defs>
                                                  ...
                                                  <g id="Group_1947" data-name="Group 1947">
                                                    <g id="Group_1946" data-name="Group 1946">
                                                      <g id="Group_1945" data-name="Group 1945">
                                                        <path id="Path_3762" data-name="Path 3762" d="M330.707,437.713l.2-.362a3.576,3.576,0,0,0-.962-4.553l-.6.6a2.742,2.742,0,0,1,1,3.182l-.746-.409a.413.413,0,0,0-.457.04.389.389,0,0,0-.1.123.41.41,0,0,0-.035.315l.83,2.842a.412.412,0,0,0,.512.282l2.843-.829a.413.413,0,0,0,.294-.352.408.408,0,0,0-.211-.406l-.714-.392a5.26,5.26,0,0,0-2.026-6.625.82.82,0,0,1,.01,1.014,4.433,4.433,0,0,1,1.112,5.586l-.2.362.545.3-1.489.434-.435-1.489.447.245Z" fill="#50C878"/>
                                                      </g>
                                                    </g>
                                                  </g>
                                                </g>
                                              ...
                                              <g id="Group_1923" data-name="Group 1923">
                                                <g id="Group_1922" data-name="Group 1922">
                                                  <g id="Group_1921" data-name="Group 1921">
                                                    <g id="Group_1920" data-name="Group 1920">
                                                      <g id="Group_1919" data-name="Group 1919">
                                                        <path id="Path_3760" data-name="Path 3760" d="M337.395,419.855h-3.479v-.8a1.412,1.412,0,0,0-1.41-1.41h-9.012a1.412,1.412,0,0,0-1.41,1.41v.8H318.6a2.857,2.857,0,0,0-2.854,2.854v1.707a2,2,0,0,0,2,2v15.938a4,4,0,0,0,4,4h12.5a4,4,0,0,0,4-4V426.416a2,2,0,0,0,2-2v-1.707A2.857,2.857,0,0,0,337.395,419.855Zm-14.311-.8a.41.41,0,0,1,.41-.41h9.012a.41.41,0,0,1,.41.41v.8h-9.832Zm13.166,23.3a2.006,2.006,0,0,1-2,2h-12.5a2.006,2.006,0,0,1-2-2V426.416h16.5Zm2-18.791v.853h-20.5v-1.707a.853.853,0,0,1,.854-.854h18.791a.853.853,0,0,1,.855.854Z" fill="#FF0000"/>
                                                      </g>
                                                    </g>
                                                  </g>
                                                </g>
                                              ...
                                              <g id="Group_1949" data-name="Group 1949">
                                                <g id="Group_1948" data-name="Group 1948">
                                                  <g id="Group_1947" data-name="Group 1947">
                                                    <g id="Group_1946" data-name="Group 1946">
                                                      <g id="Group_1945" data-name="Group 1945">
                                                        <path id="Path_3762" data-name="Path 3762" d="M330.707,437.713l.2-.362a3.576,3.576,0,0,0-.962-4.553l-.6.6a2.742,2.742,0,0,1,1,3.182l-.746-.409a.413.413,0,0,0-.457.04.389.389,0,0,0-.1.123.41.41,0,0,0-.035.315l.83,2.842a.412.412,0,0,0,.512.282l2.843-.829a.413.413,0,0,0,.294-.352.408.408,0,0,0-.211-.406l-.714-.392a5.26,5.26,0,0,0-2.026-6.625.82.82,0,0,1,.01,1.014,4.433,4.433,0,0,1,1.112,5.586l-.2.362.545.3-1.489.434-.435-1.489.447.245Z" fill="#FF0000"/>
                                                      </g>
                                                    </g>
                                                  </g>
                                                </g>
                                              ...
                                              <g id="Group_1962" data-name="Group 1962">
                                                <g id="Group_1961" data-name="Group 1961">
                                                  <g id="Group_1960" data-name="Group 1960">
                                                    <g id="Group_1959" data-name="Group 1959">
                                                      <g id="Group_1958" data-name="Group 1958">
                                                        <path id="Path_3763" data-name="Path 3763" d="M330.235,440.2a.823.823,0,0,1-.729-.463,4.43,4.43,0,0,1-5.254-1.371l-.252-.327-.493.379.2-1.539,1.538.2-.4.311-.161.124.252.327a3.577,3.577,0,0,0,4.308,1.074l-.234-.8a2.748,2.748,0,0,1-3.141-.47l.673-.518a.413.413,0,0,0,.147-.435.426.426,0,0,0-.071-.145.413.413,0,0,0-.274-.157l-2.937-.383a.414.414,0,0,0-.463.356l-.383,2.937a.413.413,0,0,0,.661.381l.645-.5a5.264,5.264,0,0,0,6.627.975l-.025.008A.829.829,0,0,1,330.235,440.2Z" fill="#FF0000"/>
                                                      </g>
                                                    </g>
                                                  </g>
                                                </g>
